...
def toml_parser(filename):
    ...
    def deal_clickables(subArray): #reshuffle data structure, adding 'clickable' and 'non_clickable', del 'dev' and 'dependencies'

        pkg_name_array = [item['name'] for item in subArray]

        #print(pkg_name_array)
